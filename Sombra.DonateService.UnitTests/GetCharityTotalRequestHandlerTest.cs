        ...
        public async Task GetCharityTotalRequestHandler_Handle_With_CharityActions_Return_Correct(){
            ...
            try{
                ...
                using (var context = DonationsContext.GetInMemoryContext())
                {
                    ...
                    var handler = new GetCharityTotalRequestHandler(context, AutoMapperHelper.BuildMapper(new MappingProfile()));
            ...
            using (var context = DonationsContext.GetInMemoryContext())
                {
                    ...
                    Assert.AreEqual(charityActionDonation.Amount + charityDonation.Amount + charityDonation1.Amount, response.TotalDonatedAmount);
                } 
            } finally {
